...
{
	public partial class Emmiter : PositionedObject, IDestroyable
	{
		...
		private static EmitterList EmitterListFile;
		
		private FlatRedBall.Graphics.Particle.EmitterList emit;
		public int Index { get; set; }
		public bool Used { get; set; }
		protected Layer LayerProvidedByContainer = null;

        public Emmiter(string contentManagerName) :
            this(contentManagerName, true)
        {
        }


        public Emmiter(string contentManagerName, bool addToManagers) :
			base()
		{
			// Don't delete this:
		...
		protected virtual void InitializeEntity(bool addToManagers)
		{
			...
			emit = new FlatRedBall.Graphics.Particle.EmitterList();
...
// Generated AddToManagers
		...
		public virtual void Destroy()
		{
			...
			if (emit != null)
			{
				emit.RemoveFromManagers(ContentManagerName != "Global");
			}
		...
		public virtual void PostInitialize ()
		{
			...
			emit.CopyAbsoluteToRelative();
			emit.AttachAllDetachedTo(this, false);
		...
		public virtual void AddToManagersBottomUp (Layer layerToAddTo)
		{
			...
			RotationY = 0;
			RotationZ = 0;
			emit.AddToManagers(layerToAddTo);
			X = oldX;
			Y = oldY;
			Z = oldZ;
		...
		public virtual void SetToIgnorePausing ()
		{
			...
			InstructionManager.IgnorePausingFor(emit);
		}
	...
	// Extra classes
	public static class EmmiterExtensionMethods
	{
	}
